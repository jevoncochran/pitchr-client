        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_380px] gap-6 items-start">
          ...
          <div className="min-w-0">
            ...
            <div className="bg-white border rounded-lg p-6 mb-6">
              ...
              {[
                {
                  icon: <FaInstagram className="text-pink-500" size="1.1em" />,
                  label: "Instagram",
                  handleKey: "instagramHandle",
                  followersKey: "instagramFollowers",
                },
                {
                  icon: <FaTiktok className="text-gray-800" size="1.1em" />,
                  label: "TikTok",
                  handleKey: "tiktokHandle",
                  followersKey: "tiktokFollowers",
                },
                {
                  icon: <FaYoutube className="text-red-500" size="1.1em" />,
                  label: "YouTube",
                  handleKey: "youtubeHandle",
                  followersKey: "youtubeFollowers",
                },
                {
                  icon: <FaFacebook className="text-blue-600" size="1.1em" />,
                  label: "Facebook",
              ...
              <div className="flex flex-col gap-2">
                {contacts.map((c) =>
                  editingContactId === c.id ? (
                    ...
                    <div
                      key={c.id}
                      className="flex items-start justify-between border rounded-lg px-4 py-3 bg-white"
                    >
            ...
            <div className="bg-white border rounded-lg p-4 mb-6">
              ...
              {attachments.length === 0 && !uploadingAttachment ? (
                <p className="text-sm text-gray-400">
                  No attachments yet. Add photos, PDFs, or videos.
                </p>
              ) : (
                    ...
                    return (
                      ...
                      >
                        ...
                        {isImage ? (
                          ...
                          <div className="w-full h-28 flex flex-col items-center justify-center gap-1 text-gray-400">
                            <FaFile size="2em" />
                            <span className="text-xs px-2 truncate w-full text-center">
                              {att.filename}
                            </span>
                            <a
                              href={att.url}
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex gap-2 mt-2">
                              ...
                              <button
                                onClick={() =>
                                  handleCheckInRespond(r.id, false)
                                }
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          setTpSequencePosition((prev) => {
                            ...
                            if (
                              IN_PERSON_TYPES.includes(newType) &&
                              isOutreachPos
                            )
                              return "";
                            if (
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setTpReceivedResponse(e.target.checked)
                        }
                      />
              ...
              {lead.touchPoint?.length === 0 ? (
                ...
                <div className="space-y-3">
                  {lead.touchPoint?.map((tp: any) =>
                              ...
                              onChange={(e) => {
                                ...
                                setEditTpForm((f: any) => {
                                  const isVisitPos = [
                                    ...
                                    "VISIT_B",
                                    "VISIT_C",
                                  ].includes(f.sequencePosition);
                                  const isOutreachPos =
                                    f.sequencePosition && !isVisitPos;
                                  const shouldReset =
                                    (IN_PERSON_TYPES.includes(newType) &&
                                      isOutreachPos) ||
                                    (!IN_PERSON_TYPES.includes(newType) &&
                          ...
                          <label className="flex items-center gap-2 cursor-pointer">
                            <input
                              ...
                              onChange={(e) =>
                                setEditTpForm((f: any) => ({
                                  ...f,
                                  receivedResponse: e.target.checked,
                                }))
                              }
                            />
                            <span>Received a response</span>
                    ...
                    ) : tp.type === "VISIT_ATTEMPT" ? (
                      // Attempt entry — muted, dashed border, no sequence badge
                      <div
                        key={tp.id}
                        className="border-l-2 border-dashed border-gray-300 pl-3 text-sm opacity-70"
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 flex-wrap">
                              <span className="font-medium text-gray-500">
                                🚪 Visit attempt — no contact
                              </span>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              {tp.sequencePosition && (
                                <span
                                  className={`text-xs px-2 py-0.5 rounded-full font-semibold ${SEQUENCE_POSITION_COLOR[tp.sequencePosition] ?? "bg-gray-100 text-gray-600"}`}
                                >
                                  {SEQUENCE_POSITION_LABEL[
                                    tp.sequencePosition
                                  ] ?? tp.sequencePosition}
